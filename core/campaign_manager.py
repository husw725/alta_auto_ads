...
class CampaignManager:
    """Meta ADS 管理器 v1.9.2: 官方配置完全对齐版"""
    
    def __init__(self):
        self.access_token = os.getenv('META_ACCESS_TOKEN')
        self.ad_account_id = os.getenv('META_AD_ACCOUNT_ID')
        self.page_id = os.getenv('META_PAGE_ID')
        # 1. 核心修正：使用 Meta 系统里唯一认可的官方配对
    ...
    def create_campaign(self, drama_name, video_url):
        try:
            ...
            story_spec = {'page_id': self.page_id, 'video_data': {'video_id': v_id, 'message': copy.get('primary_text', 'Watch on AltaTV!')}}
